                ...
                success: function(data) {
                    ...
                    for(let i = 0; i < dataCategory.length; i++){
                        $.each(dataCategory[i], function(key, val){
                            option += '<li class="filter-list"><input class="pixel-radio" type="radio" id="women' + val['id'] + '" name="category" value="' + val['id'] + '"><label for="women' + val['id'] + '">' + val['name_cate'] + '<span> (' + val['countSL'] + ')</span></label></li>';
        ...
        function load_brand(){
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for(let i = 0; i < dataCategory.length; i++){
                        $.each(dataCategory[i], function(key, val){
                            option += '<li class="filter-list"><input class="pixel-radio" type="radio" id="women' + val['id'] + '" name="brand" value="' + val['id'] + '"><label for="women' + val['id'] + '">' + val['name_brand'] + '<span> (' + val['countSL'] + ')</span></label></li>';
