            ...
            <li class="nav-item dropdown hidden-caret">
                ...
                <ul class="dropdown-menu dropdown-user animated fadeIn">
                    <div class="dropdown-user-scroll scrollbar-outer">
                        <li>
                            <div class="user-box">
                                <div class="avatar-lg"><img src="{{ asset('admin-assets/img/profile.jpg') }}" alt="image profile"
                        ...
                        <li>
                            ...
                            <a class="dropdown-item" href="{{ route('profile.edit', session('user_id')) }}">My Profile</a>
