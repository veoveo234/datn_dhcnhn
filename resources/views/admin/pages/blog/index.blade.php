            ...
            <div class="col-md-12">
                <div class="row d-flex align-items-center bg-white m-0">
                    <div class="col-md-2 mt-25 mb-25">
                        <label class="my-input" for="status-active">Thời trang</label>
