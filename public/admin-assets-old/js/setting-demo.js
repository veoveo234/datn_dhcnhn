...
function customCheckColor() {
    ...
    if (logoHeader !== "white") {
        $('.logo-header .navbar-brand').attr('src', 'http://127.0.0.1:8000/admin-assets/img/logo.svg');
        // $('.logo-header .navbar-brand').attr('src', '../assets/img/logo.svg');
    } else {
        $('.logo-header .navbar-brand').attr('src', 'http://127.0.0.1:8000/admin-assets/img/logo2.svg');
